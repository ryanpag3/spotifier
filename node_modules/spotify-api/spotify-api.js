...
SpotifyApi.prototype.getArtistNewRelease = function (artistId) {
    ...
    return this.initialize()
        ...
        .catch((err) => {
            ...
            logger.error(this.refreshToken);
...
SpotifyApi.prototype.validateInit = function (validateAccessToken) {
    return new Promise((resolve, reject) => {
        ...
        if (!this.accessToken && validateAccessToken && validateAccessToken === true) {
            let err = 'Spotify API has not initialized a valid access token which is required for this request.';
            return reject(new Errror(err));
        }
...
SpotifyApi.prototype.syncLibrary = function(user, socket) {
